...
```
This shows that if you don't own a gun you are more likely to receive punishment rather than owning a gun. 
...
the mean we reject /fall to reject the null hpothesis , and 
Indement of gun owership (OWNGUN)

the p-value for the fisher exact test was p=0.01651, and the
odds ration was 2.271. 
The odds ratio , 2.271 :1 mean that people that do not owen a gun are 2.271 times more likely to oppos captial punishment. 
